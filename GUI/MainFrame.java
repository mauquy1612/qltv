...
public class MainFrame extends JFrame {
	...
	public void thanhtitle() {
		iconEAUT = new JLabel("");
		iconEAUT.setIcon(null);
		iconEAUT.setBounds(0, 0, 30, 34);
		contentPane.add(iconEAUT);
	...
	public void menuleft() {
		...
		lblthuviensgu = new JLabel("Th\u01B0 Vi\u1EC7n EAUT");
...
//		lblthuviensgu.setIcon(new ImageIcon("img\\iconEAUT."));
...
//				"C:\\Users\\ASUS\\Pictures\\14-145167_home-icon-home-icon-png-green-removebg-preview.png"));
		...
		lblNewLabel_17.setIcon(new ImageIcon("img\\iconEAUT (2) (1).jpg"));
...
//						System.out.println(tv);
	...
	private void trangchu() {
		...
		lblNewLabel = new JLabel("CHÀO MỪNG BẠN ĐẾN VỚI THƯ VIỆN TRƯỜNG ĐẠI HỌC EAUT");
